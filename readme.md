...
- [AI编译器TVM code explain](#ai---tvm-code-explain)
- [总览](#--)
  * [run_code](#run-code)
- [前置知识](#----)
- [Python—C++ 交互接口](#python-c-------)
  * [python 2 tvm](#python-2-tvm)
  * [cython](#cython)
- [TVM](#tvm)
  ...
  * [类型转换](#----)
    + [as](#as)
- [Tir](#tir)
  * [**`tir::CommReducer`**](#---tir--commreducer---)
  * [tir::IterVar](#tir--itervar)
  * [tir:funtion](#tir-funtion)
    + [attr](#attr)
    + [params](#params)
    + [Buffer](#buffer)
    + [create](#create)
    + [print](#print)
  * [tir::Buffer](#tir--buffer)
    + [create](#create-1)
  * [tir::simt](#tir--simt)
...
- [te](#te)
  ...
  * [te::Op](#te--op)
    + [optype](#optype)
    + [create](#create-4)
    + [root_iter_vars](#root-iter-vars)
    + [inputTensors](#inputtensors)
- [relay](#relay)
  * [Doc](#doc)
- [te::Scadule](#te--scadule)
  * [create](#create-5)
    + [创建读取图](#-----)
    + [创建Stage](#--stage)
  * [Action](#action)
